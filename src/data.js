export const movies = [
  ...
  },
  {
    ...
    description:
      "Batman sets out to stop the Joker's reign of chaos and save Gotham City.",
  ...
  },
  {
    ...
    title: "Pulp Fiction",
    description:
      "Various interconnected stories unfold in the criminal underworld of Los Angeles.",
  ...
  },
  {
    ...
    posterURL: "https://example.com/fight-club-poster.jpg",
    rating: 8.8,
    duration: "2h 19min",
  ...
  },
  {
    ...
    title: "Forrest Gump",
    description:
      "The life journey of a man who witnesses several historical events during his lifetime.",
  ...
  },
  {
    ...
    title: "Inception",
    description:
      "A thief with the ability to enter people's dreams must plant an idea into a CEO's mind.",
  ...
  },
  {
    ...
    posterURL: "https://example.com/gladiator-poster.jpg",
    rating: 8.5,
    duration: "2h 35min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/lotr-return-of-the-king-poster.jpg",
    rating: 8.9,
    duration: "3h 21min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/departed-poster.jpg",
    rating: 8.5,
    duration: "2h 31min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/prestige-poster.jpg",
    rating: 8.5,
    duration: "2h 10min",
  ...
  },
  {
    ...
    title: "The Avengers",
    description:
      "A group of extraordinary individuals with superpowers unite to save Earth from an alien invasion.",
  ...
  },
  {
    ...
    description:
      "In Nazi-occupied France during World War II, a plan to assassinate Nazi leaders by a group of Jewish U.S. soldiers coincides with a theater owner's vengeful plans.",
    posterURL: "https://example.com/inglourious-basterds-poster.jpg",
    rating: 8.3,
    duration: "2h 33min",
    releaseDate: "August 20, 2009",
  },
  {
    id: 15,
    title: "The Silence of the Lambs",
    description:
      "A young FBI cadet must confide in an incarcerated and manipulative killer to receive his help in catching another serial killer.",
    posterURL: "https://example.com/silence-of-the-lambs-poster.jpg",
    rating: 8.6,
    duration: "1h 58min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/usual-suspects-poster.jpg",
    rating: 8.5,
    duration: "1h 46min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/sixth-sense-poster.jpg",
    rating: 8.1,
    duration: "1h 47min",
  ...
  },
  {
    ...
    posterURL: "https://example.com/social-network-poster.jpg",
    rating: 7.7,
    duration: "2h",
